			...
			if (selects('avg').checked && stats =='AVG') {
				...
				switch (par) {
					case 'IADP':
						...
						dashStyle: 'shortdash',				
						label:{
								text: 'DAP 90th Percentile: '  + parseFloat(DAPStats).toFixed(2) + ' mGy.cm²',
								style: {
									color: 'blue',
									fontWeight: 'bold'
									}}
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav">
					...
					<li style="padding-left:400px;" ><a  id='log'>LOGIN</a>
                        </li>
						
					<li><a  style= "font-size:11px;" id='forgot'>Forgot your key?</a>
                        </li>
			...
			<form id="forgot-pass" action="getPass.php" method= "post">
                    <input id="email" class="text" type="text" placeholder="Type your email">&nbsp;<span class="btn btn-primary btn-file"><span class="fileupload-new">Send</span><input id="send" style="display:inline-block;" value="Send email"></span>
			...
			<script>
			$("#log").click(function() {
				if (document.getElementById('loading1').style.visibility == 'visible') {
			...
			$("#go").click(function(){
					...
					if ($("#text").val()!='public') {
						...
						document.getElementById('text').placeholder = 'Type a valid key';
					}
			...
			$("#send").click(function(){
					...
					$("#forgot-pass").slideToggle();
					document.getElementById('loading1').innerHTML = "<img  id= 'spinner1' src= '25.gif'>&nbsp;&nbsp;Sending e-mail...</label>";
					document.getElementById('loading1').style.visibility = 'visible';
					e = $("#email").val();
					
					if($("#email").val()!="") {
	
						$.post( $("#forgot-pass").attr("action"), 
								//$("#myForm :input").serializeArray(),
								{email: e},
								function(data){
									switch (data) {
										case 'success':
											...
											document.getElementById('loading1').innerHTML = 'E-mail sent! Check your inbox.';
											break;
											
										case 'error':
											
											document.getElementById('loading1').innerHTML = 'Cannot send keyword to your e-mail address. Try again.';
											break;
										
										case 'invalid email':
											$("#forgot-pass").slideToggle();
											document.getElementById('loading1').innerHTML = "<img  id= 'spinner1' src= '25.gif'>&nbsp;&nbsp;</label>";
											document.getElementById('loading1').style.visibility = 'hidden';
											document.getElementById('email').value = ''; 
											document.getElementById('email').placeholder = 'Type a valid email';
											break;
	...
	<label id= 'loading1' style="visibility:hidden;color:white; margin-left:870px;padding-top:30px;"><img  id= 'spinner1' src= "25.gif">&nbsp;&nbsp;Sending e-mail...</label>
          ...
          <div class="row text-center" >
				...
				<select style = 'float:left;margin-top:-2px;'class='soflow' name=country id='s1' onchange="selects('s3').selectedIndex=0; selects('s4').style.visibility ='hidden'; selects('s5').style.visibility ='hidden';selects('s2').style.visibility ='hidden';show_select();ajaxFunction('s1');">
					...
					require "config.php";// connection to database 
						...
						$sql="select distinct modality from exam where email= (SELECT email FROM users where keyword='public');";
